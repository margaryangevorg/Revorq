...
public interface IMaintenanceOrderRepository : IRepository<MaintenanceOrder>
{
    ...
    Task<IEnumerable<MaintenanceOrder>> GetMonthlyOrdersAsync(int userId, int? assignedEngineerId, int year, int month, List<OrderStatus> statuses, bool? isUnassigned, bool? isScheduled);
