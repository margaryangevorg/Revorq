...
namespace Revorq.DAL.Migrations
{
    ...
    [Migration("20260915195521_AddReportTimeChangeHistory")]
    partial class AddReportTimeChangeHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Revorq.DAL.Entities.Elevator", b =>
                {
                    ...
                    b.Property<int>("MonthlyDefaultOrdersCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Revorq.DAL.Entities.MaintenanceOrderHistory", b =>
                {
                    ...
                    b.Property<string>("ReportTimeChanges")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasKey("OrderId");

                    b.ToTable("MaintenanceOrderHistories");
                });
            ...
            modelBuilder.Entity("Revorq.DAL.Entities.MaintenanceOrder", b =>
                {
                    ...
                    b.HasOne("Revorq.DAL.Entities.AppUser", "Reporter")
                        .WithMany()
            ...
            modelBuilder.Entity("Revorq.DAL.Entities.MaintenanceOrderHistory", b =>
                {
                    b.HasOne("Revorq.DAL.Entities.MaintenanceOrder", "Order")
                        .WithOne("History")
                        .HasForeignKey("Revorq.DAL.Entities.MaintenanceOrderHistory", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Revorq.DAL.Entities.MaintenanceReport", b =>
                {
                    b.HasOne("Revorq.DAL.Entities.MaintenanceOrder", "MaintenanceOrder")
                        .WithOne("Report")
                        .HasForeignKey("Revorq.DAL.Entities.MaintenanceReport", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
