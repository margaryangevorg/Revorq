...
{
    /// <inheritdoc />
    public partial class CreatedCompanyEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvitationTokens_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedEngineerId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceOrders_AspNetUsers_AssignedEngineerId",
                        column: x => x.AssignedEngineerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceOrders_Elevators_ElevatorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvitationTokens_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceOrders_AssignedEngineerId_ScheduledDate",
                table: "MaintenanceOrders",
                columns: new[] { "AssignedEngineerId", "ScheduledDate" });

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceOrders_ElevatorId",
                table: "MaintenanceOrders",
                column: "ElevatorId");
        }
